...
type TaskStatus = 'pending' | 'waiting' | 'running' | 'completed' | 'failed' | 'stopped';
...
export const { selectTask, updateTaskStatus, clearError, setTasks, addTask, upsertTask, startTask, stopTask, removeTask } = tasksSlice.actions;
