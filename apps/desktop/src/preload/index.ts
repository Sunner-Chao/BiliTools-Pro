...
const api = {
  ...
  tasks: {
    ...
    saveWorkflow: (config: unknown) => ipcInvoke('tasks:saveWorkflow', config),
    deleteWorkflow: (workflowId: string) => ipcInvoke('tasks:deleteWorkflow', workflowId),
    runWorkflow: (workflowId: string) => ipcInvoke('tasks:runWorkflow', workflowId),
  },
  streaming: {
    ...
    saveWorkflow: (config: unknown) => ipcInvoke('streaming:saveWorkflow', config),
    deleteWorkflow: (workflowId: string) => ipcInvoke('streaming:deleteWorkflow', workflowId),
    runWorkflow: (workflowId: string) => ipcInvoke('streaming:runWorkflow', workflowId),
  },
  daily: {
    ...
    saveWorkflow: (config: unknown) => ipcInvoke('daily:saveWorkflow', config),
    deleteWorkflow: (workflowId: string) => ipcInvoke('daily:deleteWorkflow', workflowId),
    runWorkflow: (workflowId: string) => ipcInvoke('daily:runWorkflow', workflowId),
  },
  analytics: {
