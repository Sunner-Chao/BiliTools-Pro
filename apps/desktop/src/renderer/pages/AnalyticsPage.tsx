  ...
  if (pageState === 'loading') {
    return (
      <div className="bt-page-skeleton" role="status" aria-label="加载统计数据">
        ...
        <div className="bt-skeleton-stats">
          {[0, 1, 2, 3].map(i => <div key={i} className={`bt-skeleton-stat bt-skeleton bt-stagger-${i + 5}`} />)}
        </div>
        <div className="bt-analytics-skeleton-main">
          <div className="bt-analytics-skeleton-card bt-skeleton bt-stagger-7" />
          <div className="bt-analytics-skeleton-card bt-skeleton bt-stagger-8" />
          <div className="bt-analytics-skeleton-card bt-skeleton bt-stagger-7" />
          <div className="bt-analytics-skeleton-card bt-skeleton bt-stagger-8" />
        </div>
      </div>
